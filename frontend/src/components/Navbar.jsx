...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#f6f5f2] shadow-md py-2 sm:py-4 font-serif">
      <div className="container mx-auto px-2 sm:px-4 flex items-center justify-between">
        ...
        <ul className={`md:flex md:space-x-4 lg:space-x-8 ${isMenuOpen ? 'block' : 'hidden'} md:block absolute md:relative top-full left-0 right-0 bg-[#f6f5f2] md:bg-transparent shadow-md md:shadow-none z-20`}>
          <li>
            <Link to="/" className="block py-2 px-2 sm:px-4 md:p-0 text-sm sm:text-base text-gray-600 hover:text-[#04333a]">
              Home
            </Link>
          </li>
          <li>
            <Link to="/about" className="block py-2 px-2 sm:px-4 md:p-0 text-sm sm:text-base text-gray-600 hover:text-[#04333a]">
              About
            </Link>
          </li>
          <li>
            <Link to="/contact" className="block py-2 px-2 sm:px-4 md:p-0 text-sm sm:text-base text-gray-600 hover:text-[#04333a]">
              Contact
            </Link>
          </li>
          {isAuthenticated && (
            <li>
              <Link
                to="/feedback"
                className="block py-2 px-2 sm:px-4 md:p-0 text-sm sm:text-base text-gray-600 hover:text-[#04333a]"
              >
                Feedback
              </Link>
            </li>
          ...
          <li>
            <Link to="/doctor" className="block py-2 px-2 sm:px-4 md:p-0 text-sm sm:text-base text-gray-600 hover:text-[#04333a]">
              Our Doctor
            </Link>
          </li>
        </ul>
          ...
          {isAuthenticated ? (
            <>
              ...
              {isDropdownOpen && (
                <div
                  ref={dropdownRef}
                  className="absolute top-full right-0 mt-2 w-48 bg-[#f6f5f2] border border-gray-200 rounded-lg shadow-lg z-30"
                >
                  <ul className="py-2">
                    <li>
                      <Link
            ...
            <Link to="/login" className="text-sm sm:text-base text-gray-600 hover:text-[#04333a]">
              Login
            </Link>
          )}
        </div>
