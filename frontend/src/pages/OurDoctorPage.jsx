...
//       <div className="flex-grow py-10">
//         <div className="container mx-auto px-4">
//           <h1 className="text-4xl font-bold text-center text-[#04333a] mb-8">
//             Our Doctors
//           </h1>
//           <div className="mb-6 flex flex-col md:flex-row justify-between items-center">
//             <select
//               className="mb-4 md:mb-0 p-2 border-2 border-[#04333a] rounded bg-[#e6f0f5] text-[#04333a]"
//               value={selectedSpecialty}
//               onChange={(e) => setSelectedSpecialty(e.target.value)}
//             >
//               <option value="">All Specialties</option>
...
//               type="text"
//               placeholder="Search by name"
//               className="p-2 border-2 border-[#04333a] rounded bg-[#e6f0f5] text-[#04333a]"
//               value={searchTerm}
//               onChange={(e) => setSearchTerm(e.target.value)}
//             />
//           </div>
...
//               <motion.div
//                 key={doctor.staff_id}
//                 className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-[#04333a]/30"
//               >
...
//                   />
//                 </div>
//                 <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#04333a] group-hover:from-[#04333a]/70 group-hover:via-[#04333a]/60 group-hover:to-[#04333a]/70"></div>
...
//                     className="rounded-full bg-[#e6f0f5] py-2 px-3.5 font-serif text-sm capitalize text-[#04333a] shadow shadow-[#04333a]/60 hover:bg-[#04333a] hover:text-white transition-colors duration-300"
//                   >
//                     View Profile
//                   </Link>
//                 </div>
...
//         <div className="container mx-auto px-4">
//           <h1 className="text-5xl font-bold text-center text-[#04333a] mb-12">
//             Our Doctors
//           </h1>
          ...
          >
            {currentDoctors.map((doctor, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-white bg-opacity-90 p-4 transition-all duration-300 group-hover:bg-[#04333a] group-hover:bg-opacity-90">
                  <h2 className="font-sans text-xl font-bold text-[#04333a] group-hover:text-white transition-colors duration-300">
                    {doctor.staff_name}
                  </h2>
                  <h3 className="text-lg text-[#04333a] group-hover:text-[#e6f0f5] transition-colors duration-300 mt-2 opacity-0 group-hover:opacity-100">
                    {doctor.specialty}
                  </h3>
                  <Link
                    to={`/doctor/${doctor.staff_id}`}
                    className="mt-3 inline-block rounded-full bg-[#e6f0f5] py-2 px-4 font-sans text-sm font-semibold text-[#04333a] shadow-md hover:bg-white hover:text-[#04333a] transition-colors duration-300 opacity-0 group-hover:opacity-100"
                  >
                    View Profile
                  </Link>
                </div>
