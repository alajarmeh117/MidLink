          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between space-x-4">
              ...
              <motion.button
                ...
                type="button"
                onClick={onClose}
                className="flex-1 bg-gray-500 hover:bg-gray-600 text-white font-bold py-6 px-5 rounded-lg focus:outline-none focus:shadow-outline transition duration-300"
              >
                Cancel
              </motion.button>
            </div>
