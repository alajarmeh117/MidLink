...
const FeedbackPage = () => {
  ...
  const fetchContacts = useCallback(async () => {
    ...
    try {
      const response = await axios.get(
        `https://midlink-backend.onrender.com/api/contacts?page=${currentPage}&limit=${ITEMS_PER_PAGE}`,
      );
  ...
  const fetchTotalContacts = useCallback(async () => {
    try {
      const response = await axios.get(
        "https://midlink-backend.onrender.com/api/contacts/messages/count",
      );
  ...
  const handleSendReply = useCallback(
    async (contactId, response) => {
      try {
        await axios.put(
          "https://midlink-backend.onrender.com/api/contacts/respond",
          {
            contactId,
            response,
          },
