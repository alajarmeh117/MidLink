  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-[#f6f5f2] rounded-lg shadow overflow-hidden">
          <h2 className="text-xl bg-[#04333a] text-white font-semibold p-4  border-b">
            Patients
          </h2>
                ...
                {editingPatient?.id === patient.id ? (
                  <div className="mt-2 space-y-2">
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="flex items-center px-3 py-1 bg-[#04333a] text-white rounded hover:bg-opacity-85"
                      >
                  ...
                  <div className="mt-2">
                    ...
                    <button
                      ...
                      className="mt-2 flex items-center px-3 py-1 bg-[#04333a] text-white rounded hover:bg-opacity-85"
                    >
        ...
        <div className="bg-[#f6f5f2] rounded-lg shadow overflow-hidden">
          <h2 className="text-xl bg-[#04333a] text-white font-semibold p-4 bg-gray-50 border-b">
            Health Records
          </h2>
          {selectedPatient ? (
            <div className="p-4">
                        ...
                        <>
                          ...
                          <div className="mt-2 flex space-x-2">
                            ...
                            <button
                              ...
                              className="flex items-center px-3 py-1 bg-red-500 text-white rounded   hover:bg-opacity-85 "
                            >
